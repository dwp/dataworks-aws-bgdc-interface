    ...
    "logs_collected": {
      "files": {
        "collect_list": [
          ...
          {
            "file_path": "/var/log/bgdc/acm-cert-retriever.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "acm-cert-retriever.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/nohup.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "nohup.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/install-pycrypto.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "install-pycrypto.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/install-requests.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "install-requests.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/install-boto3.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "install-boto3.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/hive-tables-creation.log",
            "log_group_name": "$${cwa_steps_loggrp_name}",
            "log_stream_name": "hive-tables-creation.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/create-hive-tables.log",
            "log_group_name": "$${cwa_steps_loggrp_name}",
            "log_stream_name": "create-hive-tables.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/generate-analytical-dataset.log",
            "log_group_name": "$${cwa_steps_loggrp_name}",
          ...
          {
            "file_path": "/var/log/bgdc/bgdc_params.log",
            "log_group_name": "$${cwa_steps_loggrp_name}",
            "log_stream_name": "bgdc_params.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/bgdc/flush-pushgateway.log",
            "log_group_name": "$${cwa_steps_loggrp_name}",
